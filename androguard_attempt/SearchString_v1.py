...
file_path = "D:\\workspace\\Android-immunity\\androguard_attempt\\toutiao\\news.apk"
store_file_path = "D:\\workspace\\Android-immunity\\androguard_attempt\\toutiao"
smali_file_path = "D:\\workspace\\Android-immunity\\androguard_attempt\\toutiao\\smali_out"
...
if __name__ == '__main__':
    ...
    for i in range(0, len(s)):
        ...
        os.system("echo search string content: " +
                  string[i] + " >> "+arsc_file_path)
